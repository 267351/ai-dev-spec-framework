...
| **v2** | `paper/final-v2.md` | 第二版：问题驱动型 | ✅ 完成 | 失败模式分析、7个弊端、2个根本缺陷、6项改进方案及其工程实现 |
| **v3** | `paper/final-v3.md` | 第三版：模型感知型 | ✅ 完成 | LLM 模型差异分析、混合流水线、元 Skills |
...
- ✅ 第1-3章：问题驱动的引言、批判性文献综述、案例研究方法论
- ✅ 第4章：创立/更新/正效应/7个弊端/跨项目对比（5000字）
- ✅ 第5章：验证闭环缺失 + 错误约定毒性 + 5.3 节解决方案设计（4500字）
- ✅ 第6章：6项改进方案的完整设计 + spec-tools 工具链工程实现（4500字）
- ✅ 第7章：研究总结、工业实践启示、局限性与未来工作（3000字）
...
|------|-----------|-----------|---------|
| 引言 | `chapters/01-introduction.md` | `chapters-v2/01-introduction.md` ✅ | 加入模型感知的问题定义 |
| 相关工作 | `chapters/02-related-work.md` | `chapters-v2/02-related-work.md` ✅ | 加入 LLM 能力评估文献 |
| 方法论 | `chapters/03-methodology.md` | `chapters-v2/03-methodology.md` ✅ | 加入混合流水线设计 |
| 深度剖析 | ❌ 无 | `chapters-v2/04-deep-analysis.md` ✅ | 加入模型感知约束设计 |
| 根本缺陷 | ❌ 无 | `chapters-v2/05-fundamental-defects.md` ✅ | 加入模型能力对缺陷的放大效应 |
| 改进方案 | ❌ 无 | `chapters-v2/06-improvement.md` ✅ | 加入模型降级策略的工具化 |
| 结论 | `chapters/06-conclusion.md` | `chapters-v2/07-conclusion.md` ✅ | 加入多模型协同的未来方向 |
